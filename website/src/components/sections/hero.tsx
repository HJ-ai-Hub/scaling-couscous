    ...
    <section className="relative overflow-hidden pb-20 pt-36 sm:pt-44 lg:pb-28">
      ...
      <div className="container-page flex flex-col items-center text-center">
        ...
        <motion.h1
          ...
          className="mx-auto mt-6 max-w-3xl text-balance text-center font-brand text-4xl font-bold leading-[1.08] tracking-tight text-ink sm:text-5xl lg:text-6xl"
        >
          {t("title")}
        </motion.h1>
        ...
        <motion.p
          ...
          className="mx-auto mt-6 max-w-xl text-balance text-center text-lg leading-relaxed text-ink-soft"
        >
          {t("description")}
        </motion.p>
        ...
        <motion.p
          ...
          className="mt-8 text-center text-sm text-ink-faint"
        >
          {t("disclaimer")}
        </motion.p>
