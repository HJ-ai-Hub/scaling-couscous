...
recital("E", "It is the express intention of the Parties that (i) the right to effect the "
        ...
        "Founder of the Transferor in the Founder’s **absolute and sole discretion**; and "
...
clause("9.2", "The Transferor further represents and warrants that, as at the Effective Date, it "
...
# 10. Restrictions pending completion
...
clause("11.1", "Each Party shall keep confidential the terms of this Agreement and all "
...
clause("12.2", "Each Party shall be responsible for its own taxes (if any) arising from the "
       "transfer of the Transfer Shares.")

# 13. Term and termination
heading("13", "Term and Termination")
clause("13.1", "This Agreement takes effect on the Effective Date and continues until the earlier "
       "of (a) Completion and (b) termination in accordance with this Clause 13.")
clause("13.2", "This Agreement may be terminated by the written agreement of the Transferor and "
...
clause("14.1", "This Agreement and any non-contractual obligations arising out of or in "
...
clause("14.3", "The Parties may, by written agreement, elect to refer any dispute instead to "
       "arbitration administered by the **Dubai International Arbitration Centre (DIAC)**, seated "
       "in Dubai and conducted in the English language.")

# 15. General / Boilerplate
...
clause("15.3", "**No Waiver.** No failure or delay in exercising any right operates as a waiver "
       "of it.")
...
clause("15.5", "**Assignment.** No Party may assign or transfer its rights or obligations under "
       "this Agreement without the prior written consent of the Transferor (acting by the "
       "Founder).")
clause("15.6", "**Further Assurance.** Each Party shall execute such further documents and do "
       "such further acts as may reasonably be required to give full effect to this Agreement.")
clause("15.7", "**Counterparts.** This Agreement may be executed in any number of counterparts, "
       "each of which is an original and all of which together constitute one agreement.")
clause("15.8", "**Notices.** Notices under this Agreement shall be in writing and delivered by "
...
clause("15.9", "**Language.** This Agreement is executed in English. Where a notarised Arabic "
...
for item in [
    ...
    "Whether disputes are to be resolved by Dubai Courts (Clause 14.2) or DIAC arbitration (Clause 14.3).",
